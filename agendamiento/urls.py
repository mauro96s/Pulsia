...
urlpatterns = [
    ...
    path('especialista/atender/<int:cita_id>/', especialista_atender_cita_view, name='especialista_atender_cita'),
    path('especialista/permiso/', especialista_solicitar_permiso_view, name='especialista_solicitar_permiso'),
    ...
    path('recepcion/reubicar-lote/', recepcion_auto_reubicar_lote_view, name='recepcion_auto_reubicar_lote'),

    # Alias para retrocompatibilidad en plantillas de recepcionista
    path('recepcion/agendar-legacy/', recepcion_agendar_reprogramar_view, name='recepcionista_agendar'),
    path('recepcion/checkin-legacy/', recepcion_checkin_medico_view, name='recepcionista_cambiar_estado'),
    path('recepcion/contingencia-legacy/', admin_declarar_ausencia_emergencia, name='recepcionista_contingencia_emergencia'),
    ...
    # Retrocompatibilidad para alias de administración
    path('administracion/empleado/crear-legacy/', admin_crear_usuario, name='admin_crear_empleado'),
    path('administracion/ausencias-legacy/', admin_permisos_view, name='admin_gestionar_ausencia'),
